	...
	<fieldset>
		<ul>
		  ...
		  <li>
			...
			<input type="number" id="userPassword" size="20">
		  </li>
		  <li>
			<label for="price">비밀번호 재확인</label>
			<input type="text" id="userPasswordRe" size="20">
		  </li>
		</ul>
	  </fieldset>
	  <fieldset>
		<ul>
		  ...
		  <li>
			...
			<input type="number" id="userPhoneNum" size="30">
		  </li>
		  <li>
			<label for="amount">주소</label>
			<input type="number" id="userAddress" size="80">
		  </li>
		</ul>
	  </fieldset>
	  <center>
